...
namespace WebApplication1
{
    public partial class Atministradores : System.Web.UI.Page
    {
        ...
        protected void BtAgregarEnt_Click(object sender, EventArgs e)
        {
            Response.Redirect("AgregarEntidad");
        }

        protected void BtEliminarEnt_Click(object sender, EventArgs e)
        {
            Response.Redirect("EliminarEntidad");
        }

        protected void BtControl_Click(object sender, EventArgs e)
        {
